...
\begin{proof}
  ...
  connect $u_x^{2i}$ to the  first vertex of the spine of a comb
  ...
  all vertices of the copies of $H$, excepth the $t_x^{2i}$'s. In particular, $M_x$ is connected and contains
  ...
  We will say that an orientation of a graph is \emph{valid} if 
  gives a line

...
\begin{proof}
  ...
  $u_x^{0}, \dots, u_x^{8m-2}$ in which for each $i \in \{0, \ldots, 4m-1\}$ we
  ...
  \begin{figure}[h!]
    ...
    \begin{tikzpicture}[scale = 1.5]
      ...
      \node[below right=-.15cm] at (H311) {\scriptsize $t_x^{8m-2}$};
      \node[below right=-.15cm] at (a3) {\scriptsize $u_x^{8m-2}$};
      \node[below right=-.15cm] at (e31) {\scriptsize $v_x^{8m-2}$};
      \node[below right=-.15cm] at (e32) {\scriptsize $w_x^{8m-2}$};
    \end{tikzpicture}  
    \caption{Variable gadget $L_x$}
  ...
  follows. Add three edges to form a path $a_ib_ic_id_i$, where $a_i=w_x^{8ki}$,
  $b_i=w_y^{8ki+2}$, $c_i=w_y^{8ki+2+4k}$ and $d_i=w_z^{8ki}$. Denote $G_\phi$ the
  constructed graph.
  ...
  For each variable $x$, denote $M_x$ the subgraph of $L_x$ induced by
  $\bigcup_{i=0}^{4mk-1} \{t_x^{2i}, u_x^{2i}, u_x^{2i+1}, v_x^{2i}, w_x^{2i}\}$.

...
the sequence.  \nicolas{In fact, below, shift graphs are precisely
  ...
  rephrase the paragraph below, keep it if you like it.}
...
odd-girth, and unbounded chromatic number. More precisely, there exists shifts
...
girth and chormatic number. We believe that the complexity results of
...
In this paper, a \emph{caterpillar} of length $k$ is a path on $k$ edges (called

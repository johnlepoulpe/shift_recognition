...
odd-girth) and chromatic number. More precisely, shifts graphs of girth at least
$g$ have unbounded chromatic number, and Zykov, Blanche-Descartes, Twincut or
Mycielski graphs with odd-girth at least $g$ have unbounded chromatic number. We
believe that the complexity results of \cref{tab:complexity} also hold with this
additional condition in these classes.

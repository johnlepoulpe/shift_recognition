...
%   away (resp. towards) the jaw, and that they are \emph{negative} otherwise.
  ...
  \begin{claim}\label{cl:clause_orientation}
    For every $i\in \{0,\ldots,4m-1\}$, in any shift orientation of $C_i$, the
    teeth of $C_i$ cannot be all positive, or all negative.  Conversely, any
  ...
  \begin{poc}
    ...
    $bb'$ and $cc'$ are oriented towards $b$ and $c$. Without loss of
    ...
    oriented $a \to b$ (see Figure~\ref{fig:variable_gadget}). We then obtain a
    ...
    \begin{figure}[htb]
      ...
      \caption{The orientation depicted in the first part of the proof of
      Claim~\ref{cl:clause_orientation}.}

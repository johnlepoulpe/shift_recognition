...
\begin{proof}
  ...
  \begin{figure}[h!]
    ...
    \begin{tikzpicture}[scale = 1.5]
      ...
      \node[below left=-.2cm] at (e03) {\footnotesize $v_x^0$};
      \node[below left=-.2cm] at (d03) {\footnotesize $w_x^0$};
      ...
      \node[below left=-.2cm] at (e13) {\footnotesize $v_x^2$};
      \node[below left=-.2cm] at (d13) {\footnotesize $w_x^2$};
      \node[below right=-.15cm] at (H311) {\footnotesize $t_x^{8m-2}$};
      \node[below right=-.15cm] at (a3) {\footnotesize $u_x^{8m-2}$};
      \node[below left=-.2cm] at (e33) {\footnotesize $v_x^{8m-2}$};
      \node[below left=-.2cm] at (d33) {\footnotesize $w_x^{8m-2}$};

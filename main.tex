...
\begin{csproblem}{Monotone Not all equal (NAE3SAT)}
  ...
  the variables such that each clause of $\phi$ contains literals with different
  values.
\end{csproblem}
...
\end{theorem}
\begin{proof}
  We reduce \textsc{Monotone NAE3SAT} to the shift graph recognition problem.

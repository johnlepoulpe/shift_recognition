...
\begin{proof}
  ...
  consider the gadget composed of a path on $8mk+3$ vertices
  $u_x^{-2}, \dots, u_x^{8mk}$ in which for each $i \in \{0, \ldots, 4mk-1\}$ we
  connect $u_x^{2i}$ to a vertex $v_x^{2i}$ itself adjacent to $w_x^{2i}$,
  and $u_x^{2i}$ to a distinct copy of $H$ via one of the vertices of
  ...
  \begin{figure}[h!]
    ...
    \begin{tikzpicture}[scale = .8]
      ...
      \node[below right=-.15cm] at (H711) {\scriptsize $t_x^{8mk-2}$};
      \node[below right=-.15cm] at (a7) {\scriptsize $u_x^{8mk-2}$};
      \node[below right=-.15cm] at (e71) {\scriptsize $v_x^{8mk-2}$};
      \node[below right=-.15cm] at (e72) {\scriptsize $w_x^{8mk-2}$};
    \end{tikzpicture}  

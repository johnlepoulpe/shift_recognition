...
\begin{proof}
  ...
  \begin{poc}
    ...
    the same reasoning along the vertices of the spine of the caterpillar
    attached to $u^{2i}_x$, the spine of the caterpillar is oriented away from
    $u^{2i}x$ and its legs away from the spine. In particular, we have

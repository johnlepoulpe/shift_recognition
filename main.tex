...
\begin{proof}
  ...
  because each copy of $H$ is acyclic and separated from the rest of $G'$ by a
  cut vertex, and the additional edges can be ordered acyclically following the
  order on the vertices of $G$. Therefore $L(G')$ is a shift graph.

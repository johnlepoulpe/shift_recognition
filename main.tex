...
In \cref{tab:complexity}, we
review the simplest constructions of triangle graphs of arbitratily
large chromatic and indicate the status of the following problems:
recognition, maximum independent set and recognition.  The goal of
this paper is to settle the three cells of the table not addressed in
available papers. 

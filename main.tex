...
constructions of triangle-free graphs with arbitratily large chromatic number.
...
\begin{table}[h!]
  ...
  the main known constructions of triangle-free graph of large chromatic number. Here, P holds for ``Polynomial'', and NPC for ``NP-Complete''. Entries with * correspond to results proved in this paper.}

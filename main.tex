...
\begin{proof}
  ...
  $8m+1$ vertices. Denote $u_x^1, \dots u_x^{4m}$ every other vertex of $U_x$,
  starting from the second vertex of $U_x$. For each $i \in \{0, \ldots, 4m-1\}$
  ...
  $t_x^{i}$'s. In particular, $M_x$ is connected and contains
  $\bigcup_{i=1}^{4m} \{t_x^{i}, u_x^{i}, v_x^{i}, w_x^{i}\}$.
  ...
  \begin{figure}[h!]
    ...
    \begin{tikzpicture}[scale = 1.5]
      ...
      \node[below right=-.15cm] at (H011) {\footnotesize $t_x^1$};
      \node[below right=-.15cm] at (a0) {\footnotesize $u_x^1$};
      \node[below left=-.1cm] at (e03) {\footnotesize $v_x^1$};
      \node[below left=-.1cm] at (d03) {\footnotesize $w_x^1$};
      ...
      \node[below right=-.15cm] at (H311) {\footnotesize $t_x^{4m}$};
      \node[below right=-.15cm] at (a3) {\footnotesize $u_x^{4m}$};
      \node[below left=-.1cm] at (e33) {\footnotesize $v_x^{4m}$};
      \node[below left=-.1cm] at (d33) {\footnotesize $w_x^{4M}$};

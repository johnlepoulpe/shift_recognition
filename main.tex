...
arbitrarily large girth.  \ugo{It seems for me that in the litterature (already
  in Wikipedia), ``shift graphs'' refer to generalised shift graphs. We should
  at least precise in the intro, that by shift we mean $G_{n,2}$ and its induced
  subgraphs, no?}
...
\nicolas{I think everything works fine by taking a graph $T$ with
  ...
  in $v_{n-1}$, uses a colour different from 2 and $c$. This contradicts 

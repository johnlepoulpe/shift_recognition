...
$k$-walk (respectively $k$-path) is a sequence of $k$ (distinct) consecutive
arcs.
...
\begin{proof}
  ...
  shift graphs. If $G_2$ is the $k$-iterated line digraph of the oriented graph $G_1$,
  ...
  We construct an acyclic oriented graph $H$ such that $\chi(L^k(H))=3$, with a marked
  ...
  with $u < v$, add the arc $x_u \to x_v$ (see \cref{fig:NP-col}). The oriented graph
